...
Instead of comparing biobanks separately, we can pool information across all of the biobanks and perform a meta-analysis, which improves the fidelity of our [effect size](effect-sizes.qmd) and [pairwise comparison](pairwise.qmd) benchmarks.
