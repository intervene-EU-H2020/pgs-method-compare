...
<p>The "raw" differences (βₓ - βᵧ) are on the same scale as the original effect sizes. Relative differenes ((βₓ - βᵧ) / βᵧ) are often reported in methods comparisons, as different phenotypes and target data may have different baseline performance.</p>
</details>
