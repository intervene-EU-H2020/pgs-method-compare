...
<details>
  ...
  <dl>
    ...
    <dt>R²</dt>
    <dd>This is the variance explained by the PGS on the observed scale for continuous traits, or on the liability scale for continuous traits</dd>
  </dl>
</details>


This interactive plot corresponds to Figure 1A and **Supplementary Figures XX** in the published article.
