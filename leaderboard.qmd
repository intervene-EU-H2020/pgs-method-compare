...
table_columns = {
  if (use_relative === "relative") {
    return ["relative_rank", "method_x", "method_type_x", "method_y", "ancestry", "relative_beta_with_ci"];
  } else {
    return ["rank", "method_x", "method_type_x", "method_y", "ancestry", "beta_with_ci"];
  }
}
...
filtered_pairwise = aq.fromJSON(pv_mrg)
  ...
  .derive({
    ...
    relative_ci_high_diff: d => aq.roundfloat(d.relative_ci_low_diff, 3)
  })
  .derive({
